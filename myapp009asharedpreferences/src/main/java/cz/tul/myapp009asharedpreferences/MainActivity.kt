package cz.tul.myapp009asharedpreferences
...
import cz.tul.myapp009asharedpreferences.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (ageString.isBlank()) {
                Toast.makeText(this, "Prosím, vyplňte věk", Toast.LENGTH_SHORT).show()
            } else {
                val age = ageString.toInt()
                val isAdult = binding.cbAdult.isChecked
                if ((age < 18 && isAdult) || (age >= 18 && !isAdult)) {
                    Toast.makeText(this, "Musíte být starší než 17 let", Toast.LENGTH_SHORT).show()
                } else {
